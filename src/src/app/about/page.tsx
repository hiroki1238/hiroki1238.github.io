  ...
  return (
    <div className="mt-16 w-5/7 mr-auto ml-auto">
      ...
      <p className="text-2xl mt-10 mr-10 text-gray-600">
        「株式会社たば」は2023年9月にHiroki1238によって設立されたポートフォリオサイトです。株式会社たばは「毎日楽しい」を目標に、こだわりを持って開発したサービスを提供しています。複数あるサービスを通じて、誰もが自由に楽しく生きていける社会を目指します。
      </p>
      ...
      <div className="text-2xl mt-10 text-gray-600 grid grid-cols-2 w-full">
        ...
        <div className="border-b-2 my-3">10万円（2023年9月時点）</div>
